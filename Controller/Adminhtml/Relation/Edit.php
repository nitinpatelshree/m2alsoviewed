...
namespace Jay\Alsoviewed\Controller\Adminhtml\Relation;
...
class Edit extends \Magento\Backend\App\Action
{
     ...
     * @see _isAllowed()
     */
    const ADMIN_RESOURCE = 'Jay_Alsoviewed::relation';

    /**
     * @var \Jay\Alsoviewed\Model\RelationFactory
     */
     ...
     * @param \Jay\Alsoviewed\Model\RelationFactory $relationFactory
     * @param \Magento\Framework\View\Result\PageFactory $resultPageFactory
     */
    public function __construct(
        \Magento\Backend\App\Action\Context $context,
        \Jay\Alsoviewed\Model\RelationFactory $relationFactory,
    ...
    public function execute()
    {
        ...
        $resultPage->setActiveMenu('Jay_Alsoviewed::alsoviewed_relation')
