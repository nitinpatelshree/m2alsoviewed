...
namespace Jay\Alsoviewed\Observer;
...
class LogRelations implements \Magento\Framework\Event\ObserverInterface
{
    ...
    /**
     * @var \Jay\Alsoviewed\Model\ResourceModel\LogFactory
     */
    protected $logFactory;

    /**
     * @var \Jay\Alsoviewed\Helper\Data
     */
    protected $helper;
     ...
     * @param \Jay\Alsoviewed\Model\ResourceModel\LogFactory $logFactory
     */
    public function __construct(
        \Magento\Framework\Session\SessionManagerInterface $session,
        \Magento\Framework\App\Config\ScopeConfigInterface $scopeConfig,
        \Jay\Alsoviewed\Model\ResourceModel\LogFactory $logFactory,
        \Jay\Alsoviewed\Helper\Data $helper
    ) {
