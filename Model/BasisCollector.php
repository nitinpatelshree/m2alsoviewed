...
namespace Jay\Alsoviewed\Model;
...
class BasisCollector
{
    ...
    protected $basisClasses = [
        self::BASIS_CURRENT_PRODUCT     => '\Jay\Alsoviewed\Model\Basis\CurrentProduct',
        self::BASIS_RECENTLY_VIEWED     => '\Jay\Alsoviewed\Model\Basis\RecentlyViewed',
        self::BASIS_RECENTLY_COMPARED   => '\Jay\Alsoviewed\Model\Basis\RecentlyCompared',
        self::BASIS_SHOPPING_CART       => '\Jay\Alsoviewed\Model\Basis\ShoppingCart',
    ];
